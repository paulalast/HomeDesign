...
const Footer = () => {
	...
	const SocialMedia = ({ src, alt }) => {
		return (
			<div className='flex w-full items-center justify-center  max-md:mx-1 max-md:mt-2 my-1 '>
				<img
					className='w-10  max-lg:w-7 hover:scale-105 duration-500 cursor-pointer  mx-1 hover:bg-orange-700 rounded-full'
					src={src}
					alt={alt}
				/>
			</div>
	...
	return (
		<footer className='flex flex-row justify-center items-center mt-14 border-top-2 opacity-60 hover:opacity-100 duration-300  max-md:items-center max-md:mb-2 max-md:flex-col-reverse'>
			...
			<div className='w-2 h-10 bg-orange-700 border-none mx-4 max-md:w-full  max-md:h-1 max-md:mx-0' />
